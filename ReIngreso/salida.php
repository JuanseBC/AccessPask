...
date_default_timezone_set('America/bogota');
 ...
 <label >fecha: <input type="text" name="fech" value="<?php echo  date("Y-m-d ") ?>"readonly></input></label><br>
 <label >hora de salida: <input type="text" name="hoSa" value="<?php echo date("g:i A")?>"readonly></input></label><br>
