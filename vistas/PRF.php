...
<body>
    ...
    <main>
        ...
        <div class="cuadro_texto2">Seleccione su curso</div>
        ...
        mysqli_select_db($con,$bd);
         ...
         <div class="container d-flex flex-wrap gap-3 p-4 li ">
            <a class="card text-decoration-none"  href="excest.php?id=<?php echo $cursos['Curso'];?>" style="width: 15rem;color:white;height:3rem"><?php echo "Grado  ".$cursos['Curso'];?></a>
        </div>
